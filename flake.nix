{
  ...
  description = "A simple CLI to convert an image to webp";
  ...
  outputs = { self, nixpkgs, flake-utils }:
    ...
    flake-utils.lib.eachDefaultSystem(system:
      let
        ...
        # (and call it 'towebp'
        towebp = with pkgs; stdenv.mkDerivation {
          ...
          # of our output
          installPhase = "install -Dm755 ${./towebp.py} $out/bin/towebp";
        };
      in rec {
        ...
        # 'towebp' and if the flake is run this will be what is run
        packages.default = towebp;
      }
  );
}
